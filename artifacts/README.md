...
|  |  | a full 27,972-row re-run of the judge over the same candidate sets, released so the 93.5% specific / 97.1% broad reproduction figure in the paper can be checked without a GPU |
|  | the organisers' final standings | all 18 teams with their seven official metrics; the source for the paper's rank and for the rank-2 comparison in Table 2 |
