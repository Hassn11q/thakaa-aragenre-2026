# -*- coding: utf-8 -*-
"""Hand-written cues for distinguishing the 74 test genres.

Each entry records a surface or content cue that separates a genre from nearby labels, such as
dialect, orthography, isnad, book-description wording, news datelines, job domain, textbook level,
or essay topic. The family judge appends these cues to the released definitions. We wrote them
from the definitions and Arabic linguistic knowledge; they do not use dataset labels.
"""
